...
if __name__ == '__main__':
    ...
    patientsMutationVariantPathEvidence = []
    patientIDs = []
    for withheldPatientHash in withheldPatientHashes:
        ...
        patientMutationVariantPathEvidence = []
        for idx, mut in enumerate(genes):
            compName = 'mut-var_'+mut+"-"+variants[idx] +'='
            if compName in compNames:
                patientMutationVariantEvidence[compName] = 'True'
        ...
        patientMutationVariantPathEvidence.append((pathEvidence, patientMutationVariantEvidence))
        ...
        patientsMutationVariantPathEvidence.append(patientMutationVariantPathEvidence)
