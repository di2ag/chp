...
class CrossValidator:
    ...
    def run_demo_only(self, target, patID, evidence):
        ...
        if self.first:
            ...
            #for comp_name, state_dict in query.result.updates.items():
...
if __name__ == '__main__':
    ...
    #fused_bkb.load('/home/public/data/ncats/BabelBKBs/collapsed660BKB/fusion.bkb')
    #patient_data_file = '/home/public/data/ncats/BabelBKBs/collapsed660BKB/patient_data.pk'
    #withheld_patients_file = '/home/public/data/ncats/BabelBKBs/collapsed660BKB/withheldPatients.csv'
