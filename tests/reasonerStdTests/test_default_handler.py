...
class testExploringAgent(unittest.TestCase):
    ...
    def test_negative(self):
        ...
        reasoner_std['query_graph']['nodes']['n1'] = { 'type':'chemical_substance',
                                                       'curie':'{}'.format(drug[1])
                                                     }
        # add in disease node
        ...
        reasoner_std['query_graph']['nodes']['n3'] = { 'type': 'phenotypic_feature',
        ...
        reasoner_std['query_graph']['edges']['e2'] = { 'type':'disease_to_phenotypic_feature_association',
                                                       'source_id': 'n2',
                                                       'target_id': 'n3',
    ...
    def test_normal_two_genes_and_drug(self):
        ...
        reasoner_std['query_graph']['nodes']['n2'] = { 'type':'chemical_substance',
                                                       'curie':'{}'.format(drug[1])
                                                     }
        # add in disease node
        disease = ('Breast_Cancer', 'MONDO:0007254')
        ...
        # add target survival node
        phenotype = ('Survival_Time', 'EFO:0000714')
        reasoner_std['query_graph']['nodes']['n4'] = { 'type': 'phenotypic_feature',
                                                       'curie': '{}'.format(phenotype[1]),
                                                     }
        # link genes/drugs to disease
        reasoner_std['query_graph']['edges']['e0'] = { 'type':'gene_to_disease_association',
        ...
        # link disease to target
        reasoner_std['query_graph']['edges']['e3'] = { 'type':'disease_to_phenotypic_feature_association',
                                                       'source_id': 'n3',
                                                       'target_id': 'n4',
                                                       'properties': { 'qualifier':'>=',
                                                                       'value':970
	...
	# empty response
        ...
        # add target survival node
        phenotype = ('Survival_Time', 'EFO:0000714')
        reasoner_std['query_graph']['nodes']['n1'] = { 'type': 'phenotypic_feature',
                                                       'curie': '{}'.format(phenotype[1]),
                                                     }
        # link disease to target
        reasoner_std['query_graph']['edges']['e0'] = { 'type':'disease_to_phenotypic_feature_association',
                                                       'source_id': 'n0',
                                                       'target_id': 'n1',
                                                       'properties': { 'qualifier':'>=',
                                                                       'value':970
    ...
    def test_one_gene(self):
        ...
        # add target survival node
        phenotype = ('Survival_Time', 'EFO:0000714')
        reasoner_std['query_graph']['nodes']['n2'] = { 'type': 'phenotypic_feature',
                                                       'curie': '{}'.format(phenotype[1]),
                                                     }
        # link genes/drugs to disease
        reasoner_std['query_graph']['edges']['e0'] = { 'type':'gene_to_disease_association',
        ...
        # link disease to target
        reasoner_std['query_graph']['edges']['e1'] = { 'type':'disease_to_phenotypic_feature_association',
                                                       'source_id': 'n1',
                                                       'target_id': 'n2',
                                                       'properties': { 'qualifier':'>=',
                                                                       'value':970
    ...
    def test_one_drug(self):
        ...
        # add in evidence drug
        drug = ('CYCLOPHOSPHAMIDE', 'CHEMBL:CHEMBL88')
        reasoner_std['query_graph']['nodes']['n0'] = { 'type':'chemical_substance',
                                                       'curie':'{}'.format(drug[1])
                                                     }
         # add in disease node
        disease = ('Breast_Cancer', 'MONDO:0007254')
